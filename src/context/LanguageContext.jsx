...
const translations = {
    vi: {
        ...
        pythonDesc: 'Tự động hóa và xử lý dữ liệu',
        htmlCssDesc: 'Phát triển giao diện web',
        javascriptDesc: 'Lập trình web frontend',
    ...
    en: {
        ...
        pythonDesc: 'Automation and data processing',
        htmlCssDesc: 'Web interface development',
        javascriptDesc: 'Frontend web development',
